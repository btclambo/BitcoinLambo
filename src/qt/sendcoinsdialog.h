...
#ifndef BITCOINLAMBO_QT_SENDCOINSDIALOG_H
#define BITCOINLAMBO_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinlambos */
...
#endif // BITCOINLAMBO_QT_SENDCOINSDIALOG_H
