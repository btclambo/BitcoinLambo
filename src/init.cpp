 ...
 * between bitcoinlambod, and bitcoinlambo-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("bitcoinlambo-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), BITCOINLAMBO_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinlambo/bitcoinlambo>";
    const std::string URL_WEBSITE = "<https://bitcoinlambocore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitcoinlambo-loadblk");
...
/** Sanity checks
 *  Ensure that BitcoinLambo is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BitcoinLambo version %s\n", FormatFullVersion());
}
...
bool AppInitParameterInteraction()
{
    ...
    if (gArgs.GetBoolArg("-disablefork", false)) {
        printf("NOTE: disabling fork; this node will run on the bitcoinlambo network\n");
        FORK_ALLOWED = false;
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single BitcoinLambo process is using the data directory.
...
// ********************************************************* Step 4a: application initialization
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", BITCOINLAMBO_CONF_FILENAME)).string());
