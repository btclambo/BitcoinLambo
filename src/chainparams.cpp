...
public:
    CMainParams()
    {
        ...
        vSeeds.emplace_back("seed.bitcoinlambo.sipa.be", true); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me", true); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.bitcoinlambo.dashjr.org", false); // Luke Dashjr
        vSeeds.emplace_back("seed.bitcoinlambostats.com", true); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.bitcoinlambo.jonasschnelli.ch", true); // Jonas Schnelli, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("testnet-seed.bitcoinlambo.jonasschnelli.ch", true);
...
public:
    CRegTestParams()
    {
        ...
        consensus.BIP34Height = 500; // This is deactivated on bitcoinlambo, but we activate it on the fork block here, as we otherwise won't get the fork hash coinbase
