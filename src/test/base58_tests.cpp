...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if (isPrivkey) {
            ...
            // Note: CBitcoinLamboSecret::SetString tests isValid, whereas CBitcoinLamboAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    CBitcoinLamboAddress dummyAddr;
