...
#ifndef BITCOINLAMBO_TEST_SCRIPTNUM10_H
#define BITCOINLAMBO_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinLambo Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINLAMBO_TEST_BIGNUM_H
