...
#ifndef BITCOINLAMBO_WALLET_WALLET_H
#define BITCOINLAMBO_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinlambo node, and set to 0 for transactions that were created
...
#endif // BITCOINLAMBO_WALLET_WALLET_H
