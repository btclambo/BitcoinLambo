...
#ifndef BITCOINLAMBO_CONSENSUS_CONSENSUS_H
#define BITCOINLAMBO_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinLambo parameters, but if this fork is a fork
...
#endif // BITCOINLAMBO_CONSENSUS_CONSENSUS_H
