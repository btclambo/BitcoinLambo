...
unlocked to sign the BitcoinLambo-Qt.app bundle.
...
allowing somebody to distribute a BitcoinLambo-Qt.app or bitcoinlambo-qt-setup.exe with a valid
...
that the bitcoinlambo-qt.exe file inside the installer had not been tampered with.
