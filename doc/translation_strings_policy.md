...
This document provides guidelines for internationalization of the BitcoinLambo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinlambo_en.ts` remains unchanged.
