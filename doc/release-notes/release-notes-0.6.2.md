BitcoinLambo version 0.6.2 is now available for download at:
http://sourceforge.net/projects/bitcoinlambo/files/BitcoinLambo/bitcoinlambo-0.6.2/
...
Fixed https://github.com/bitcoinlambo/bitcoinlambo/issues/1065, a bug that
