BitcoinLambo Core version 0.10.3 is now available from:

  <https://bitcoinlambo.org/bin/bitcoinlambo-core-0.10.3/>
...
(see https://github.com/bitcoinlambo/bitcoinlambo/pull/6793, as well as the 0.11.0
