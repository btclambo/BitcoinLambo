BitcoinLambo-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinlambo/files/BitcoinLambo/bitcoinlambo-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinLambo
...
New/changed settings (command-line or bitcoinlambo.conf file)
--------------------------------------------------------
