BitcoinLambo Core version 0.13.2 is now available from:

  <https://bitcoinlambo.org/bin/bitcoinlambo-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinlambo-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinlambo-tx to create v2 transactions (btcdrak)
