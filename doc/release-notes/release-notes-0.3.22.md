Download URL: https://sourceforge.net/projects/bitcoinlambo/files/BitcoinLambo/bitcoinlambo-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTL fee schedule (users still pay 0.01 BTL per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinlambo00 - #bitcoinlambo99
