BitcoinLambo Core version 0.9.2.1 is now available from:

  https://bitcoinlambo.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTL to 0.01 BTL
...
- Fix "Start bitcoinlambo on system login"
