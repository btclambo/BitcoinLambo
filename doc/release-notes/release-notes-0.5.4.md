BitcoinLambo version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinlambo/files/BitcoinLambo/bitcoinlambo-0.5.4/
...
http://gitorious.org/bitcoinlambo/bitcoinlambod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinLambo-Qt notifications under Growl 1.3.
Increase required age of BitcoinLambo-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinLambo properly when installing BitcoinLambo-Qt over it. (Windows)
