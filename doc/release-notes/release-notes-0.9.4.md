BitcoinLambo Core version 0.9.4 is now available from:

  https://bitcoinlambo.org/bin/0.9.4/
...
this update is incompatible with the BitcoinLambo system and could lead to consensus
forks.

BitcoinLambo Core released binaries from https://bitcoinlambo.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinlambo/+archive/ubuntu/bitcoinlambo
- A third-party or self-compiled BitcoinLambo Core

upgrade to BitcoinLambo Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
