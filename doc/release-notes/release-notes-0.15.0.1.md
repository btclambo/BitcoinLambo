BitcoinLambo Core version *0.15.0.1* is now available from:

  <https://bitcoinlambo.org/bin/bitcoinlambo-core-0.15.0.1/>

and

  <https://bitcoinlambocore.org/bin/bitcoinlambo-core-0.15.0.1/>
