BitcoinLambo Core version 0.14.2 is now available from:

  <https://bitcoinlambo.org/bin/bitcoinlambo-core-0.14.2/>
...
(in BitcoinLambo Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in BitcoinLambo-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitcoinlambo-config.h as necessary (theuni)
