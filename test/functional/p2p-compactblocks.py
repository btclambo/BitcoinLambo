...
# TestNode: A peer we use to send messages to bitcoinlambod, and store responses.
...
class CompactBlocksTest(BitcoinLamboTestFramework):
    ...
    # This test actually causes bitcoinlambod to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinlambod's choice of nonce.
    ...
    # Test that bitcoinlambod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinlambod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinlambod will not send blocktxn responses for blocks whose height is
