...
class BIP66Test(BitcoinLamboTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoinlambod is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoinlambod produces more specific reject
            # reasons.
