...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinLamboTestFramework
    pass

class ExampleTest(BitcoinLamboTestFramework):
    # Each functional test is a subclass of the BitcoinLamboTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinLamboTestFramework class so other tests can use it."""
