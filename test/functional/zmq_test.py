...
from test_framework.test_framework import BitcoinLamboTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BitcoinLamboTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitcoinlambo has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitcoinlambod has not been built with zmq enabled.")
